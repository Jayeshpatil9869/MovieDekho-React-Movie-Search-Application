...
const TvDetails = () => {
  ...
  return (
    <div
      ...
      className="w-screen h-[205vh] px-[10%]"
    >
      ...
      <div className="w-full flex ">
        ...
        <div className="content ml-[5%] text-white relative">
          ...
          <h1 className="text-xl font-semibold italic">{info.detail.tagline || "No Tagline Available"}</h1>
      ...
      <h1 className="text-2xl font-semibold text-white mt-6">Seasons</h1>
